...
class ConditionedEEGNet(nn.Module):
    def __init__(
        ...
        self.eeg_bn = ConditionedBatchNorm(self.eeg_dim, num_subjects)
        ...
        self.subject_bn = ConditionedBatchNorm(self.embed_dim, num_subjects)
    ...
    def forward(self, eeg_data: torch.Tensor, subject_id: torch.Tensor) -> torch.Tensor:
        ...
        subject_average = self.subject_averages[subject_id]
    ...
    @classmethod
    def from_config(cls, config, subject_averages, device="cpu"):
        ...
        return cls(subject_averages=subject_averages, **kwargs)
