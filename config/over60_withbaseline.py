...
cfg = dict(
    ...
    model=dict(
        ...
        subject_filters = 6,        # Number of filters in the subject encoder
        final_features = 4,         # Number of features after concatenation
        
        # Other parameters
        embed_dim= 16,              # Dimension of the embedding for the attention mechanism
        ),
    train=dict(
        batch_size=64,
        normalize=True,
